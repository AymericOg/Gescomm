...
public class Gescom {
    ...
    private static void listerClients(Representant unRepresentant) {
        System.out.println("Liste des clients par le représentant"+ unRepresentant.getPrenom() + " " + unRepresentant.getNom() + " : ");
    ...
    private static void afficherCommande(Commande uneCommande) {
        //affiche info commande
        System.out.println("Numéro de commande : " + uneCommande.getIdCommande() + ", passée le : " + uneCommande.getDateCommande());
        System.out.println("Détails des articles commandés :");

        // affiche détaille de chaque articles
        for (Ligne ligne : uneCommande.getLesLignes()) {
            Article article = ligne.getUnArticle(); // Obtenir l'article lié à la ligne
            System.out.println("L'article avec l'ID " + article.getIdArticle()
                    + " est un(e) " + article.getDesignation()
                    + " avec une quantité commandée de : " + ligne.getQteCommande() + " unités.");
        }
    }
}
